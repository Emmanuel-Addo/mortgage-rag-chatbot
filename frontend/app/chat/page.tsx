  ...
  return (
    ...
    <div className="h-screen w-full overflow-hidden bg-slate-100 p-6 flex items-stretch font-sans">
      ...
      <div className="flex w-full rounded-3xl overflow-hidden shadow-xl shadow-gray-200/80 border border-gray-200">
        ...
        {/* ── SIDEBAR ── */}
        <aside className={`flex flex-col h-full shrink-0 transition-all duration-300 overflow-hidden bg-[#F9F9F9] border-r border-gray-100 ${sidebarOpen ? "w-60" : "w-0"}`}>
          ...
          <div className="px-5 pt-6 pb-5 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-sm font-semibold text-gray-800">MortgageAI</span>
            </div>
          ...
          <div className="px-3 mb-2 shrink-0">
            <button onClick={() => setMessages([])} className="w-full flex items-center gap-2.5 px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition cursor-pointer font-medium">
              <svg className="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          ...
          <div className="px-3 mb-5 shrink-0">
            <button className="w-full flex items-center gap-2.5 px-3 py-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 transition cursor-pointer">
              <svg className="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          ...
          <div className="flex-1 overflow-y-auto px-3 min-h-0">
            <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest px-2 mb-2">Recents</p>
            {recentChats.map((chat, i) => (
              <button key={i} onClick={() => sendMessage(chat)} className="w-full text-left px-3 py-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-800 transition cursor-pointer truncate block mb-0.5">
                {chat}
              </button>
            ))}
          </div>
          ...
          <div className="p-4 shrink-0">
            <div className="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-gray-100 cursor-pointer transition group">
